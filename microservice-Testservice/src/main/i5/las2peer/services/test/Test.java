...
public class Test extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "Testservice", version = "1.0",
          description = "A las2peer microservice generated by the CAE.",
          termsOfService = "none",
          contact = @Contact(name = "Testdevelop", email = "CAEAddress@gmail.com") ,
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Test123")
  })
